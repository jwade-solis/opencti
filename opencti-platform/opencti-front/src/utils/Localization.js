const i18n = {
  messages: {
    'es-es': {
      ...
      'Create investigation': 'Crear una investigación',
      ...
      'Entity tags': 'Etiquetas de entidad',
      ...
      'Import a widget': 'Importar un widget',
      'Create a widget': 'Crear un widget',
      ...
      'Files volumes in S3': 'Volúmenes de archivos en S3',
      'S3 volume by file type': 'S3 Volúmenes per typo de archivos',
      'Files count': 'Recuento de archivos',
      'Files size': 'Tamaño de archivos',
      'File types to index': 'Tipos de archivos que indexar',
      ...
      'Last indexation': 'Última indexación',
      Pause: 'Pausa',
      ...
      container_type: 'Tipo de análisis',
      'based-on': 'Basado en un observable',
      sightedBy: 'Detectado por/en',
      entity_type: 'Tipo de entidad',
      relationship_type: 'Tipo de relación',
      indicator_types: 'Tipo de indicador',
      pattern_type: 'Tipo de patrón',
      incident_type: 'Tipo de incidente',
      x_opencti_main_observable_type: 'Tipo de observable',
      objectLabel: 'Etiqueta',
      createdBy: 'Autor',
      category: 'Categoría',
      entity_types: 'Tipo de entidads',
      ...
      members_user: 'Usuario',
      members_group: 'Grupo',
      members_organization: 'Organización',
      creator_id: 'Creador técnico',
      objectMarking: 'Clasificación',
      objects: 'Contiene',
      x_opencti_workflow_id: 'Estado',
      report_types: 'Tipo de informe',
      channel_types: 'Tipo de canal',
      event_scope: 'Event scope',
      event_type: 'Tipo de evento',
      event_types: 'Tipo de evento',
      context: 'Contexto',
      confidence: 'Confianza',
      confidence_gt: 'Confianza superior a',
      confidence_lte: 'Confianza inferior o igual a',
      published: 'Publicado',
      published_gt: 'Publicado después de',
      published_lt: 'Publicado antes de',
      created: 'Creado',
      created_gt: 'Creado después de',
      created_lt: 'Creado antes de',
      created_at_gt: 'Ingerido después de',
      created_at_lt: 'Ingerido antes de',
      likelihood: 'Probabilidad',
      likelihood_gt: 'Probabilidad superior a',
      likelihood_lte: 'Probabilidad inferior o igual a',
      note_types: 'Tipos de nota',
      modified: 'Actualizado',
      modified_gt: 'Actualizado después de',
      modified_lt: 'Actualizado antes de',
      valid: 'Válido',
      valid_from_gt: 'Válido desde',
      valid_until_lt: 'Válido hasta',
      x_opencti_score: 'Score',
      x_opencti_negative: 'Calificación',
      x_opencti_score_gt: 'Score superior a',
      x_opencti_score_lte: 'Score inferior o igual a',
      x_opencti_detection: 'Detección',
      x_opencti_base_score: 'CVSS3 Score',
      x_opencti_base_score_gt: 'CVSS3 Score superior a',
      x_opencti_base_score_lte: 'CVSS3 Score inferior o igual a',
      x_opencti_base_severity: 'Severidad CVSS3',
      x_opencti_attack_vector: 'Vector de ataque CVSS3',
      toCreatedAt: 'Ingerido',
      toCreatedAt_gt: 'Ingerido después',
      toCreatedAt_lt: 'Ingerido antes',
      x_opencti_organization_type: 'Tipo de organización',
      x_opencti_reliability: 'Fiabilidad',
      source_reliability: 'Fiabilidad del autor',
      indicates: 'Indica',
      containers: 'Casos y Análisis',
      revoked: 'Revocado',
      toSightingId: 'Detectado en',
      fromId: 'Entidad de origen',
      toId: 'Entidad de destino',
      fromTypes: 'Tipo de origen',
      toTypes: 'Tipo de destino',
      elementId: 'Entidad relacionada',
      connectedToId: 'Entidad relacionada',
      killChainPhase: 'Fase de la «kill chain»',
      killChainPhases: 'Fases de la «kill chain»',
      malware_types: 'Tipos de malware',
      targets: 'Entidad de destino',
      objectAssignee: 'Referente',
      objectParticipant: 'Participante',
      priority: 'Prioridad',
      severity: 'Gravedad',
      is_read: '¿Es leído?',
      start_time: 'Fecha de inicio',
      start_time_lt: 'Fecha de inicio antes',
      start_time_gt: 'Fecha de inicio después',
      stop_time: 'Fecha de finalización antes',
      stop_time_lt: 'Fecha de finalización antes',
      stop_time_gt: 'Fecha de finalización después de',
      source: 'Fuente',
      user_id: 'Usuario',
      ...
      'Greater than/ Equals': 'Mayor que o igual',
      'Lower than': 'Menor que',
      'Lower than/ Equals': 'Menor que o igual',
      'is empty': 'está vacío',
    ...
    'fr-fr': {
      ...
      'Import a widget': 'Importer un widget',
      ...
      'Files volumes in S3': 'Volume des fichiers sur S3',
      'S3 volume by file type': 'Volume sur S3 par type de fichier',
      'Files count': 'Nombre de fichiers',
      'Files size': 'Taille des fichiers',
      'File types to index': 'Types de fichiers à indexer',
      ...
      'Last indexation': 'Dernière indexation',
      Pause: 'Pause',
      ...
      operator_gt: 'après',
      operator_lt: 'avant',
      container_type: "Type d'analyse",
      'based-on': 'Basé sur un observable',
      sightedBy: 'Détecté par/dans',
      entity_type: "Type d'entité",
      relationship_type: 'Type de relation',
      indicator_types: "Type d'indicateur",
      pattern_type: 'Type de motif',
      incident_type: "Type d'incident",
      x_opencti_main_observable_type: "Type d'observable",
      objectLabel: 'Label',
      createdBy: 'Auteur',
      category: 'Catégorie',
      entity_types: "Types d'entité",
      contextEntityId: 'Entité liée',
      contextEntityType: "Types d'entités liées",
      contextCreator: "Créateur de l'entité liée",
      contextCreatedBy: "Auteur de l'entité liée",
      contextObjectLabel: "Label de l'entité liée",
      contextObjectMarking: "Marquage de l'entité liée",
      members_user: 'Utilisateur',
      members_group: 'Groupe',
      members_organization: 'Organisation',
      creator_id: 'Créateur technique',
      objectMarking: 'Marquage',
      objects: 'Contient',
      x_opencti_workflow_id: 'Statut',
      report_types: 'Type de rapport',
      channel_types: 'Type de canal',
      event_scope: 'Event scope',
      event_type: "Type d'évènement",
      event_types: "Type d'évènement",
      context: 'Contexte',
      confidence_gt: 'Confiance supérieure à',
      confidence_lte: 'Confiance inférieure ou égale à',
      published: 'Publié',
      published_gt: 'Publié après',
      published_lt: 'Publié avant',
      created: 'Créé',
      created_gt: 'Créé après',
      created_lt: 'Créé avant',
      created_at: 'Ingéré',
      created_at_gt: 'Ingéré après',
      created_at_lt: 'Ingéré avant',
      likelihood: 'Probabilité',
      likelihood_gt: 'Probabilité supérieur à',
      likelihood_lte: 'Probabilité inférieur ou égal à',
      note_types: 'Types de note',
      modified: 'Modifié',
      modified_gt: 'Modifié après',
      modified_lt: 'Modifié avant',
      valid_from: 'Valid',
      valid_from_gt: 'Valid depuis',
      valid_until_lt: "Valide jusqu'à",
      x_opencti_score: 'Score',
      x_opencti_negative: 'Qualification',
      x_opencti_score_gt: 'Score supérieur à',
      x_opencti_score_lte: 'Score inférieur ou égal à',
      x_opencti_detection: 'Détection',
      x_opencti_base_score: 'CVSS3-Score',
      x_opencti_base_score_gt: 'CVSS3-Score supérieur à',
      x_opencti_base_score_lte: 'CVSS3-Score inférieur ou égal à',
      x_opencti_base_severity: 'CVSS3-Severity',
      x_opencti_attack_vector: 'CVSS3-Attack vector',
      toCreatedAt: 'Ingéré',
      toCreatedAt_gt: 'Ingéré après',
      toCreatedAt_lt: 'Ingéré avant',
      x_opencti_organization_type: "Type d'organisation",
      x_opencti_reliability: 'Fiabilité',
      source_reliability: "Fiabilité de l'auteur",
      indicates: 'Indique',
      containers: 'Cases et analyse',
      revoked: 'Révoqué',
      toSightingId: 'Détect dans/en',
      fromId: 'Entité source',
      toId: 'Entité cible',
      fromTypes: 'Type source',
      toTypes: 'Type destination',
      elementId: 'Entité liée',
      connectedToId: 'Entité liée',
      killChainPhase: 'Phase de kill chain',
      killChainPhases: 'Phases de kill chain',
      malware_types: 'Type de code malveillant',
      targets: 'Entité cible',
      objectAssignee: 'Référent',
      objectParticipant: 'Participant',
      priority: 'Priorité',
      severity: 'Sévérité',
      is_read: 'Est lu?',
      start_time: 'Date de début',
      start_time_lt: 'Date de début avant',
      start_time_gt: 'Date de début après',
      stop_time: 'Date de fin',
      stop_time_lt: 'Date de fin avant',
      stop_time_gt: 'Date de fin après',
      source: 'Source',
      user_id: 'Utilisateur',
      ...
      'Greater than/ Equals': 'Supérieur à/Égal',
      'Lower than': 'Inférieur à',
      'Lower than/ Equals': 'Inférieur à/Égal',
      'is empty': 'est vide',
    ...
    'ja-jp': {
      ...
      'Export as PDF': 'PDF出力',
      'Download as PNG': 'PNGとしてダウンロード',
      'Download as SVG': 'SVGとしてダウンロード',
      'Download as CSV': 'CSVとしてダウンロード',
      'Import a widget': 'ウィジェットをインポートする',
      'Create a widget': 'ウィジェットを作成する',
      'Export JSON': 'JSONをエクスポートする',
      ...
      'Files volumes in S3': 'S3 のファイル ボリューム',
      'File types to index': 'インデックスを作成するファイルの種類',
      ...
      operator_gt: '後',
      operator_lt: '以前は',
      container_type: '分析の種別',
      'based-on': '観測結果をベースにする',
      sightedBy: '目撃情報',
      entity_type: 'エンティティ種別',
      relationship_type: 'リレーションシップ種別',
      indicator_types: 'インジケータ種別',
      pattern_type: 'パターンタイプ',
      incident_type: 'インシデントの種類',
      x_opencti_main_observable_type: '観測結果の種別',
      objectLabel: 'ラベル',
      createdBy: '作成者',
      category: 'カテゴリー',
      entity_types: 'エンティティ タイプ',
      contextEntityId: 'Related entity',
      contextEntityType: 'Types of related entity',
      contextCreator: 'Creator of related entity',
      contextCreatedBy: 'Author of related entity',
      ...
      members_user: '使い手',
      members_group: '族',
      members_organization: '組織',
      creator_id: 'テクニカルクリエーター',
      objectMarking: 'データマーキング',
      objects: '含む',
      x_opencti_workflow_id: 'ステータス',
      report_types: 'レポート種別',
      channel_types: 'チャネル種別',
      event_scope: 'Event scope',
      event_type: 'イベント・タイプ',
      event_types: 'イベント・タイプ',
      context: 'コンテキスト',
      confidence_gt: 'より大きい信頼度',
      confidence_lte: '以下の信頼度',
      published: '公開日時',
      published_gt: '公開日時(開始)',
      published_lt: '公開日時(終了)',
      created: '作成日時',
      created_gt: '作成日時(開始)',
      created_lt: '作成日時(終了)',
      created_at: '作成日時',
      created_at_gt: '作成日時(開始)',
      created_at_lt: '作成日時(終了)',
      likelihood: '可能性',
      likelihood_gt: '可能性大于',
      ...
      modified_lt: '変更日時(終了)',
      valid: '有効期間',
      valid_from_gt: '有効期間(開始)',
      valid_until_lt: '有効期間(終了)',
      x_opencti_score: 'スコア',
      x_opencti_negative: '判定',
      x_opencti_score_gt: '最低スコア',
      x_opencti_score_lte: '最高スコア',
      x_opencti_detection: '検知',
      x_opencti_base_score: 'CVSS3-スコア',
      x_opencti_base_score_gt: 'CVSS3 スコア最低値',
      x_opencti_base_score_lte: 'CVSS3 最高スコア',
      x_opencti_base_severity: 'CVSS3 重要度',
      x_opencti_attack_vector: 'CVSS3 攻撃ベクタ',
      toCreatedAt: '作成日時',
      toCreatedAt_gt: '作成日時(開始)',
      toCreatedAt_lt: '作成日時(終了)',
      x_opencti_organization_type: '組織種別',
      x_opencti_reliability: '信頼性',
      source_reliability: '著者の信頼性',
      indicates: '指し示す',
      containers: '事例と分析',
      revoked: '失効',
      toSightingId: '目撃情報',
      ...
      toTypes: 'ターゲットのタイプ',
      elementId: '関連エンティティ',
      connectedToId: '関連エンティティ',
      killChainPhase: 'キルチェーンフェーズ',
      killChainPhases: 'キルチェーンフェーズ',
      malware_types: 'マルウェア種別',
      targets: 'ターゲットのエンティティ',
      objectAssignee: '譲受人',
      objectParticipant: '参加者',
      priority: '優先順位',
      severity: '重大度',
      is_read: '読まれる？',
      start_time: '開始日',
      start_time_lt: '開始日より前',
      start_time_gt: '開始日以降',
      stop_time: '終了日',
      stop_time_lt: '終了日より前',
      stop_time_gt: '終了日以降',
      ...
      'Not empty': '非空',
      'Greater than': 'より大きい',
      'Greater than/ Equals': 'より大きい/等しい',
      'Lower than': 'より小さい',
      'Lower than/ Equals': 'より小さい/等しい',
      'is empty': '空である',
      'is not empty': '空でない',
      Contains: 'を含む',
      'Not contains': 'を含まない',
    ...
    'zh-cn': {
      ...
      'Download as CSV': '下载为CSV',
      'Import a widget': '导入小部件',
      ...
      'Last indexation': '最后指数化',
      Pause: 'ポーズ',
      'Indexed files': 'インデックスされたファイル',
      'Volume indexed': '巻数索引',
      Requirements: '必要条件',
      'File indexing needs one of these requirements':
      ...
      pattern_type: '图案类型',
      incident_type: '事件类型',
      x_opencti_main_observable_type: '可观测数据类型',
      objectLabel: '标签',
      createdBy: '作者',
      category: '類別',
      entity_types: '實體類型',
      ...
      members_user: '用戶',
      members_group: '班組',
      members_organization: '公家',
      creator_id: '技術創造者',
      objectMarking: '标记',
      objects: '包含',
      x_opencti_workflow_id: '状态',
      report_types: '报告类型',
      channel_types: '渠道类型',
      event_scope: 'Event scope',
      event_type: '事件類型',
      ...
      modified_lt: '修改结束日期',
      valid: '有效期',
      valid_from_gt: '有效期开始日期',
      valid_until_lt: '有效期结束日期',
      x_opencti_score: '分數',
      x_opencti_negative: '資質',
      x_opencti_score_gt: '分数大于',
      x_opencti_score_lte: '分数小于等于',
      x_opencti_detection: '检测',
      x_opencti_base_score: 'CVSS3-分數',
      x_opencti_base_score_gt: 'CVSS3-分数大雨',
      x_opencti_base_score_lte: 'CVSS3-小於或等於分數',
      x_opencti_base_severity: 'CVSS3-严重性',
      x_opencti_attack_vector: 'CVSS3-攻击向量',
      toCreatedAt: '创建',
      toCreatedAt_gt: '创建开始日期',
      toCreatedAt_lt: '创建结束日期',
      x_opencti_organization_type: '组织类型',
      x_opencti_reliability: '可靠性',
      source_reliability: '作者的可靠性',
      indicates: '指示',
      containers: '案例与分析',
      revoked: '撤销',
      toSightingId: '目击ID',
      ...
      elementId: '相关实体',
      connectedToId: '相关实体',
      killChainPhase: '杀伤链阶段',
      killChainPhases: '杀伤链阶段',
      malware_types: '恶意软件类型',
      targets: '目标实体',
      objectAssignee: '受让人',
      objectParticipant: '参与者',
      priority: '优先',
      severity: '严重性',
      is_read: '是读？',
      start_time: '开始时间',
      start_time_lt: '之前的開始日期',
      start_time_gt: '之後的開始日期',
      stop_time: '结束时间',
      stop_time_lt: '之前的結束日期',
      stop_time_gt: '之後的結束日期',
      source: '来源',
      user_id: '用戶',
      trigger_type: '觸發器類型',
      instance_trigger: '實例觸發器',
      'No filtering': '觸發器類型',
      Creator_id: '造物主',
    ...
    'en-us': {
      ...
      x_opencti_main_observable_type: 'Observable type',
      objectLabel: 'Label',
      createdBy: 'Author',
      category: 'Category',
